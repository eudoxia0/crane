...
Crane autoconnects to all the databases specified in the \c{:databases} key of the
configuration when the \c{crane:connect} function is called (No parameters).

Configuration for the databases might look like this:

\code[lang=lisp]{(setup
